create or replace view vw_gsub_rate_schedules as 
select NULL id_acc, '1 - override GSUB' rate_type, '2' rate_type_id, SUB.id_group id_group, SUB.id_sub, SUB.id_po, NULL tx_name, NULL gsub_start, NULL gsub_end,
