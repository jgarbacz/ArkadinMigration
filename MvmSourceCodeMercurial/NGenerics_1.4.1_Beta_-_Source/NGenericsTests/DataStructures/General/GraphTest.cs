...
namespace NGenerics.Tests.DataStructures.General
{
    ...
    public class GraphTest
    {
        ...
        [TestFixture]
        public class IncomingEdgeCount
        {
            [Test]
            public void Directed()
            {
        ...
        [TestFixture]
        public class IsWeaklyConnected
        {
            [Test]
            [ExpectedException(typeof(InvalidOperationException))]
			public void ExceptionEmptyDirected()
        ...
        private static Graph<int> GetTestDirectedGraph()
        {
            var graph = new Graph<int>(true);
        ...
        private static List<Edge<int>> GetEdgeList(IEnumerator<Edge<int>> edges)
        {
            var edgeList = new List<Edge<int>>();
        ...
        private static void TestIsCopy(Vertex<int> vertex1, Vertex<int> vertex2)
        {
            Assert.AreNotSame(vertex1, vertex2);
            Assert.AreEqual(vertex1.Data, vertex2.Data);
        }

        private static void TestIsCopy(Edge<int> edge1, Edge<int> edge2)
        {
        ...
        private static void TestEnumerator(IEnumerable<int> g)
        {
        ...
        private static List<Vertex<int>> GetVertices(Graph<int> g)
        {
        ...
        private static Graph<int> GetTestUndirectedGraph()
        {
            var graph = new Graph<int>(false);
        ...
        private static void TestCopyTo(ICollection<int> graph)
        {
            var array = new int[20];
            graph.CopyTo(array, 0);
        ...
        private static List<Edge<int>> GetEdges(Graph<int> g)
        {
            var list = g.Edges;
