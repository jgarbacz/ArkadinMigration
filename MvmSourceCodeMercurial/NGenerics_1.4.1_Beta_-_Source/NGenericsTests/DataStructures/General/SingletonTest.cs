...
namespace NGenerics.Tests.DataStructures.General
{
    ...
    public class SingletonTest
    {
        ...
        [TestFixture]
        public class AssignConstructWith
        {
            [TestFixtureSetUp]
            public void SetupSingleton()
            {
        ...
        [TestFixture]
        public class ActivatorConstruction
        {
            #region Instance class
        ...
        [TestFixture]
        public class ParametricConstruction
        {
            #region Instance class
        ...
        private static class TypeExtensions
        {
            ...
            private static TDelegate GetConstructor<TDelegate>(Type type, params Type[] argumentTypes)
            {
