...
{
	public partial class ObservableSplayTree<TKey, TValue> : INotifyCollectionChanged, INotifyPropertyChanged
	{
		#region Globals
		...
		/// <inheritdoc />
		public ObservableSplayTree(IComparer<TKey> comparer)
            : base(comparer)
		{
			monitor = new SimpleMonitor();
        }
