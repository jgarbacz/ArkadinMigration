...
{
	public partial class ObservableBinarySearchTree<TKey, TValue> : INotifyCollectionChanged, INotifyPropertyChanged
	{
		#region Globals
        ...
        /// <inheritdoc />
		public ObservableBinarySearchTree()
		{
		...
		/// <inheritdoc />
		public ObservableBinarySearchTree(IComparer<TKey> comparer)
			: base(comparer)
		{
			monitor = new SimpleMonitor();
		}
