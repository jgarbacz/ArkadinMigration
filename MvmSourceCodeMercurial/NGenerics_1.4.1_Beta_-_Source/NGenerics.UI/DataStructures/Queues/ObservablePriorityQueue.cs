...
{
    /// <summary>
    /// Represents a dynamic data <see cref="PriorityQueue{TValue, TPriority}"/> that provides notifications when items get added, removed, or when the whole list is refreshed.
    /// </summary>
