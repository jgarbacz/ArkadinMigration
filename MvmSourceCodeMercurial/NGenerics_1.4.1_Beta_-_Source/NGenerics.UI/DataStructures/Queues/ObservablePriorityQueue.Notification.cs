...
{
	public partial class ObservablePriorityQueue<TValue, TPriority> : INotifyCollectionChanged, INotifyPropertyChanged
	{
		#region Globals
		...
		/// <inheritdoc />
		public ObservablePriorityQueue(PriorityQueueType queueType): base(queueType)
		{
