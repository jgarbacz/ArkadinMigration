...

{
    public class MSQueue<T>
    {
        ...
        struct pointer_t
        {
            ...
            /// <summary>
            /// constructor that allows caller to specify dicPtr and count
            /// </summary>
        ...
        public void enqueue(T t)
        {
            ...
            {
                // read Tail.dicPtr and Tail.count together
                pointer_t tail = Tail;

                // read next dicPtr and next count together
