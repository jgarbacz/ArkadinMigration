...
{
    /// <summary>
    /// Creates a RawFileEnumeratorForward by reading from the BinaryReader.
    /// </summary>
    /// <typeparam name="K"></typeparam>
    /// <typeparam name="V"></typeparam>
    public class RawFileEnumeratorForward<K, V> : IRawMergeEnumerator<K,V>
    {
        private FileStream fileStream;
        private BinaryReader breader;
        public RawFileEnumeratorForward(FileStream stream, int count)
        {
