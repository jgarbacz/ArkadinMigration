...
namespace MVM
{
    ...
    public class MUsageHookRelease : IModuleSetup, IModuleRun
    {
        ...
        {
            MUsageHookRelease m = new MUsageHookRelease();
        ...
        public void Run(ModuleContext mc)
        {
            ...
            usageHookObject.Release();
            mc.globalContext.RmNamedClassInst(hookName);
        }
    }
}
