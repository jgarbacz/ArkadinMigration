...
namespace MVM
{
    [Module(@"
        <module_config>
            <name>bfs_delete_file</name>
            <xsd xmlns:xs='http://www.w3.org/2001/XMLSchema'>
                <xs:element type='bfs_flush_file_type'/>
            </xsd>
            <doc>
                <category>BFS</category>
                <description>Deletes a BFS file</description>
            </doc>
        </module_config>
    ")]
    public class MBfsDeleteFile : BaseModuleSetup, IModuleRun
    {
        // from xml
        ...
        {
            MBfsDeleteFile m = new MBfsDeleteFile();
            // xml extraction
        ...
        public void Run(ModuleContext mc)
        {
            ...
            bool result = mc.globalContext.bfs.DeleteFile(file);
