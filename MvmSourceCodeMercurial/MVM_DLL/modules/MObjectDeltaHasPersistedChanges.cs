...
namespace MVM
{
    class MObjectDeltaHasPersistedChanges: IModuleSetup,IModuleRun
    {
        ...
        {
            MObjectDeltaHasPersistedChanges m = new MObjectDeltaHasPersistedChanges();
        ...
        public void Run(ModuleContext mc)
        {
            ...
            using (IObjectData obj = mc.objectCache.CheckOut(objectId))
            {
                ...
                if (deltaObj != null)
                {
                    this.valueParsed.Write(mc,deltaObj.HasPersistedChanges ? "1":"0");
                }
            }
        }
    }
