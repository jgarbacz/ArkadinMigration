...
namespace MVM
{
    class MObjectDeltaUnpackOriginals: IModuleSetup,IModuleRun
    {
        ...
        {
            MObjectDeltaUnpackOriginals m = new MObjectDeltaUnpackOriginals();
        ...
        public void Run(ModuleContext mc)
        {
            ...
            using (IObjectData obj = mc.objectCache.CheckOut(objectId))
            {
                ...
                if (deltaObj != null)
                {
                    deltaObj.UnpackOriginals(fieldName);
                }
            }
        }
    }
